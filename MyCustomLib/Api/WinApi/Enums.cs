...
namespace MyCustomLib.Api.WinApi
{
      ...
      public enum WM : uint
      {
            ...
            /// <summary>
            /// The WM_QUEUESYNC message is sent by a computer-based training (CBT) application to separate user-input messages from other messages sent through the JOURNALPLAYBACK Hook procedure.
            /// </summary>
            QUEUESYNC = 0x0023,
            /// <summary>
      ...
      public enum WH : int
      {
            ...
            JOURNALRECORD = 0,
            /// <summary>
            /// Installs a hook procedure that posts messages previously recorded by a JOURNALRECORD hook procedure.
